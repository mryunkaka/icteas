...
<head>
    ...
    <title>Login &mdash; SI ICT</title>
                    ...
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <?php endif; ?>
                                <form method="POST" action="<?= site_url('auth/logproses') ?>" class="needs-validation" novalidate="">
                                    <?= csrf_field() ?>
                        ...
                        <div class="mt-5 text-muted text-center">
                            Belum memiliki Akun? <a href="<?= site_url('auth/register') ?>">Buat Disini</a>
                        </div>
                        <div class="simple-footer">
                            Copyright &copy; SI ICT 2023
                        </div>
                    </div>
                </div>
            </div>
